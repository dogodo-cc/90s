...
由于Mac OS的干净整洁，一直都是我的电脑首选。从16年至今，都是使用mac发，在此沉淀一篇设置文章，以便在更换电脑的时候，轻车熟路的进行配置。

个人性格原因，喜欢小而美，且一直坚持断舍离原则，只保留必要的东西，甚至可以忍受一点点由于极简带来小麻烦。所以我有一个原则，只要 Mac OS自带的APP能基本满足我的需求，我就不会安装一个替代的第三方APP。

我使用的原生APP有： 输入法、备忘录、邮件、日历、地图、音乐、截屏、提醒事项、keynote、Safari（日常）。苹果的APP完成度还是非常高的，相比国内的APP而言少了运营化的模块，整个APP完全面向生产力，无广告（零容忍），所以日常的APP我基本使用原生的。

由于音乐版权的问题，会额外使用网易云音乐作为辅助，为什么不是QQ音乐等其他？因为网易云的UI交互是我认为做的最好的。（当然如果可以去掉运营化的部分就更好）。
