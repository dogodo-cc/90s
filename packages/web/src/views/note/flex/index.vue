  ...
  <div class="page page-flex">
    <div class="item-box" :style="flexContainerValue">
        <div
          ...
          :key="index"
          :style="{width:`${item.w}`, height:`${item.h}`, lineHeight:`${item.h}`}"
        >{{index + 1}}</div>
        <div v-if="show" class="item" :style="testItemStyle">我是用来测试项目属性的方块</div>
      </div>
      <div class="control">
        <div class="control-attr">
          ...
          <div class="attr" v-for="(attr,i) in flexContainer" :key="i">
            ...
            <div class="value-box">
              <el-tooltip
                ...
                :open-delay="2000"
                placement="top"
                v-for="attrV in attr.attributeValues"
                :key="attrV.value"
              >
                <el-radio
                  v-model="flexContainerValue[attr.attribute]"
                  :label="attrV.value"
                >{{attrV.value}}</el-radio>
              </el-tooltip>
            </div>
          </div>
          <h3>项目的属性</h3>
          ...
          <div class="attr">
            ...
            <div>
              <el-checkbox v-model="show">点我</el-checkbox>
            </div>
          </div>
        </div>
        <div class="add-del">
